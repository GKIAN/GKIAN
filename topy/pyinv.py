...
ap.add_argument('+i', '--ninit', metavar = 'numInitModel',
  default = dpars['+i'], type = int, help = 'the number of initial models. ' +
  '[default: %(default)s]')
...
ap.add_argument('-b', '--hwinit', metavar = 'halfWidthInit', type = float,
  ...
  'use m/s as unit; if None, it will take min(vs)/4. [default: %(default)s]')
ap.add_argument('+I', '--impinit', metavar = 'fileImpInit',
  default = dpars['+I'], help = 'the name of file for importing initial ' +
  "models. It will ignore '+i', '+r' and '-b'. [default: %(default)s]")
